...
export const LayoutTextFlip = ({
  ...
  return (
    <>
      <motion.span
        layoutId="subtext"
        className="text-2xl font-bold tracking-tight drop-shadow-lg md:text-4xl bg-linear-to-r from-cyan-400 via-blue-400 to-purple-500 text-transparent bg-clip-text"
      >
        {text}
      </motion.span>
